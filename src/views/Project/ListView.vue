<template>
              ...
              <div v-if="cell.species">
                ...
                <div v-if="cell.searchBy === 'name'">
                  <a-form-item label="Name" name="name">
                    <a-input v-model:value="cell.name" placeholder="Click to search" @focus="handleCellNameSearch"
                             ref="cellNameInput"/>
                  </a-form-item>
                </div>
                <div v-else>
  ...
  <CellNameModal ref="cellNameRef" @confirm="handleCellNameChange"></CellNameModal>
</template>
<script setup>
import { ref } from 'vue'
