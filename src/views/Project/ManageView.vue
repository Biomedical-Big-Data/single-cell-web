...
const handleToProjectRemove = (record) => {
  Modal.confirm({
    ...
    content: 'It cannot be recovered after deleting the project, and it will cause users who share the project to be unable to use the project, whether to continue or not?',
    onOk: async () => {
      try {
        removing.value = true
