  ...
  <div class="auth-container">
    <div class="content-container">
      ...
      <a-form ref="formRef" :model="registerForm" :rules="rules">
        <a-form-item ref="formRef" class="w-full form-item" name="email_address">
          <div class="label">
            Email address
          </div>
          <div>
            <a-input
                v-model:value="registerForm.email_address" class="simple-input"
        ...
        <a-form-item class="w-full form-item" name="user_name">
          ...
          <div>
            <a-input
                v-model:value="registerForm.user_name" class="simple-input"
                placeholder="Enter your user name"></a-input>
          </div>
        </a-form-item>
        <a-form-item class="w-full form-item" name="organization">
          ...
          <div>
            <a-input
                v-model:value="registerForm.organization" class="simple-input"
                placeholder="Enter your organization"></a-input>
          </div>
        </a-form-item>
        <a-form-item class="w-full form-item" name="user_password">
          ...
          <div>
            <a-input-password
                v-model:value="registerForm.user_password" class="simple-input"
        ...
        <a-form-item class="w-full form-item" name="user_verify_password">
          ...
          <div>
            <a-input-password
                v-model:value="registerForm.user_verify_password" class="simple-input"
                placeholder="Confirm your password"></a-input-password>
          </div>
        </a-form-item>
      ...
      <div>
        <div class="w-full justify-center flex">
          <a-button class="login" :loading="loading" @click="handleUserRegister">
            Sign up
          </a-button>
        </div>
...
const handleUserRegister = async function () {
  ...
  try {
    loading.value = true
    const { user_name, user_password, organization, email_address } = registerForm.value
